    ...
    <>
      ...
      <main className="mx-auto max-w-xl w-full px-4 py-6 sm:py-10 flex-1">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          ...
          <Link
            href={`/balcao/vender/${venda.id}/recibo`}
            className="h-14 inline-flex items-center justify-center gap-2 rounded-2xl border border-line px-5 font-semibold text-ink hover:bg-surface-2"
          >
